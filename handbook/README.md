...
这是一个完全静态、可离线部署的 CCBC 现场参考手册。默认入口按照“当前卡在哪个解题阶段”逐步定位下一条可验证路径；机制图鉴则按“看到什么、反复做什么、怎样提取、需要什么知识”四个问题组织。手册还包含一页速查、资料搜索、完整历年题库，以及默认折叠的官方提示、答案、题解、扩展内容和交互源码档案。
...
handbook/
  ...
  tests/smoke.mjs         桌面、窄桌面和手机端浏览回归测试
