---
record_id: "ccbc16:puzzle:37"
event_id: "ccbc16"
editions: ["CCBC 16"]
year: 2025
area: "火药"
kind: "puzzle"
source_url: "https://ccbc16.cipherpuzzles.com/data/puzzles/37.json"
---
...
<img src="../../../assets/static.cipherpuzzles.com/static/images/e406a4b82d3e4dcfbadccfa26d9d4d5b.webp" class="pimg" />
<style>
.pimg {
    width: 800px;
}
...
![题图](../../../assets/static.cipherpuzzles.com/static/images/c7de5d26b231470bb7a5d1bf67be47d1.webp)

## 碎片 2-1

<img src="../../../assets/static.cipherpuzzles.com/static/images/d9a17db7a3724fc58f08dce861509491.webp" class="pimg" />
<style>
.pimg {
    width: 800px;
}
...
![题图](../../../assets/static.cipherpuzzles.com/static/images/93ea16de1497448f8a09346906737221.webp)

## 碎片 6-1

<img src="../../../assets/static.cipherpuzzles.com/static/images/02c845bcdc9e4e14bb5f3a6b3e6169d4.webp" class="pimg" />
<style>
.pimg {
    width: 800px;
}
...
![题图](../../../assets/static.cipherpuzzles.com/static/images/92d60a9e6e3f4c6ca1b378d490c10770.webp)
...
本题由以下几个碎片组成：
<div id="dodec_solution">
<img class="tn" src="../../../assets/static.cipherpuzzles.com/static/images/c7de5d26b231470bb7a5d1bf67be47d1.webp">
<img class="tn" src="../../../assets/static.cipherpuzzles.com/static/images/93ea16de1497448f8a09346906737221.webp">
<img class="tn" src="../../../assets/static.cipherpuzzles.com/static/images/92d60a9e6e3f4c6ca1b378d490c10770.webp">

本题标题“柏拉图式相爱”在提示这一题需要拼出一个正多面体（柏拉图多面体），这里自然是正十二面体。

拼的规则为五边形每条边上的要求必须符合该边相邻的另一五边形中心的数字。满足所有的条件时，可以拼出这样的多面体：<a href="../../../assets/static.cipherpuzzles.com/static/images/7eb3ecefaf0e479bae5fe667881775e3.glb">下载GLB 3D模型</a>。

如果设备没有打开以上文件的软件，可以使用 <a href="https://gltf-viewer.donmccurdy.com/" target="_blank">glTF Viewer 网站</a>。

然后{12} -> {6} 意味着我们需要将12个面上的数转化为6个，由FT中的“星球的另一端”和“相差几何”很容易想到取相对面上的数之差，即：
128-125=3, 65-17=48, 83-11=72, 42-12=30, 610-2=608, 111-59=52.

得到的六个数 {3, 48, 72, 30, 608, 52} 该怎样转化六个字母呢？注意到它们似乎都有很小的素因子，于是尝试写出分解式：
...
于是按2的幂次排列并将奇数部分按A1Z26转字母得到最终答案`COMICS`.
...
将得到的六个数进行因子分解，按2的个数排序，并将剩下的部分A1Z26。

### 4. {12} -> {6} 是怎么做到的

由FT中的“星球的另一端”和“相差几何”很容易想到取相对面上的数之差
...
- [7eb3ecefaf0e479bae5fe667881775e3.glb](../../../assets/static.cipherpuzzles.com/static/images/7eb3ecefaf0e479bae5fe667881775e3.glb)
...
- [d470eb12ba994fb6b5f08215aee98e94.svg](../../../assets/static.cipherpuzzles.com/static/images/d470eb12ba994fb6b5f08215aee98e94.svg)
...
来源：[https://ccbc16.cipherpuzzles.com/data/puzzles/37.json](https://ccbc16.cipherpuzzles.com/data/puzzles/37.json)
