---
record_id: "ccbc12:problem:a-p1853"
event_id: "ccbc12"
editions: ["CCBC 12"]
year: 2022
area: "时间线A"
kind: "puzzle"
source_url: "https://archive.cipherpuzzles.com/ccbc12/problems/a/p1853.yaml"
---

# #1853 welcome_to_ccbc_ctf (Web) - CCBC 12
...
<img src="../../../assets/archive.cipherpuzzles.com/ccbc12/images/answer/a-1853.png" style="width: 250px" />
...
可以网上搜索一下如何打开浏览器的控制台。在控制台里你能找到一段以"Your flag is:"开头的信息。

### 2. 该如何提取

好长的字串，里面还藏了八个flag！试着把这八个flag完整地拿出来再看看有没有别的flag吧。每个flag通过ASCII编码方式对应答案中的一个字母。


## 本地附件

- [a-1853.png](../../../assets/archive.cipherpuzzles.com/ccbc12/images/answer/a-1853.png)

来源：[https://archive.cipherpuzzles.com/ccbc12/problems/a/p1853.yaml](https://archive.cipherpuzzles.com/ccbc12/problems/a/p1853.yaml)
